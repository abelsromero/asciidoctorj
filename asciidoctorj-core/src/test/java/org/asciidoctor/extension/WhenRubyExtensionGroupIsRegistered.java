...
public class WhenRubyExtensionGroupIsRegistered {
    ...
    @ClasspathResource("sample-with-ruby-yell-block.ad")
    private File sampleWithRubyYellBlock;

    @ClasspathResource("ruby-extensions")
    private File rubyExtensionsDir;
    ...
    public void ruby_block_macro_processor_should_be_registered_with_block_name() {
        ...
        this.asciidoctor.createGroup()
                .loadRubyClass(getClass().getResourceAsStream("/ruby-extensions/gist-block-macro.rb"))
                .rubyBlockMacro("mygist", "GistBlockMacro")
                .register();
    ...
    public void ruby_inline_macro_processor_should_be_registered_with_macro_name() {
        ...
        this.asciidoctor.createGroup()
                .loadRubyClass(getClass().getResourceAsStream("/ruby-extensions/man-inline-macro.rb"))
                .rubyInlineMacro("myman", "ManInlineMacro")
                .register();
    ...
    public void ruby_inline_macro_processor_should_be_registered_with_implicit_macro_name() {
        ...
        this.asciidoctor.createGroup()
                .loadRubyClass(getClass().getResourceAsStream("/ruby-extensions/man-inline-macro.rb"))
                .rubyInlineMacro("ManInlineMacro")
                .register();
    ...
    public void ruby_postprocessor_should_be_registered() {
        ...
        final String rubyExtPath = rubyExtensionsDir.getAbsolutePath();
